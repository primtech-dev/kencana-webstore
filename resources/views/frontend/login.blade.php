        ...
        <div class="flex flex-col sm:flex-row bg-white rounded-xl shadow-2xl overflow-hidden w-full max-w-4xl">
            ...
            <div class="hidden sm:flex flex-col justify-center items-center p-8 bg-primary text-white w-1/2">
                <div class="text-center space-y-4">
                    ...
                    <h3 class="text-3xl font-extrabold">Jelajahi Dunia Belanja</h3>
                    <p class="">Masuk dan temukan ribuan produk terbaik yang kami sediakan khusus untuk Anda.</p>
                </div>
            </div>

            <div class="w-full sm:w-1/2 p-8 lg:p-12 space-y-6">
                <h2 class="text-2xl font-bold text-gray-900 text-center sm:text-left">Masuk ke Akun Anda</h2>
                ...
                <form method="POST" action="{{ route('customer.login') }}" class="space-y-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('customer.forgot.password.show') }}" class="text-sm font-medium text-primary hover:text-primary-dark">Lupa Kata Sandi?</a>
                        </div>
                ...
                <div class="text-center pt-4">
                    <p class="text-sm text-gray-600">
                        Belum punya akun?
                        <a href="{{ route('customer.register.show') }}" class="font-bold">Daftar Sekarang</a>
                    </p>
                </div>
            </div>
        </div>
