            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100 delivery-block" 
                    ...
                    <div class="flex justify-between items-center pb-4 border-b border-gray-100">
                        ...
                        <button class="text-primary font-bold text-sm hover:underline select-address-btn" data-branch-id="{{ $branchId }}">
                            Pilih Alamat Lain
                        </button>
                    </div>
                    ...
                    <div class="pt-4 pb-4 border-b border-gray-100 mb-4 flex space-x-4">
                        <button class="flex-1 py-2 px-4 rounded-lg font-bold text-sm transition delivery-mode-btn mode-delivery-{{ $branchId }} bg-primary text-white"
                                data-branch-id="{{ $branchId }}" data-mode="delivery">
                            <i class="fas fa-truck mr-1"></i> Kirim ke Alamat
                        </button>
                        <button class="flex-1 py-2 px-4 rounded-lg font-bold text-sm transition delivery-mode-btn mode-pickup-{{ $branchId }} bg-gray-100 text-gray-700 hover:bg-gray-200"
...
{{-- ========================================================= --}}
{{-- 4. JAVASCRIPT LOGIC (Pickup vs Delivery) --}}
{{-- ========================================================= --}}
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // 1. Hitung total saat halaman pertama kali dimuat
        calculateFinalTotal(); 

        // 2. Inisiasi Mode Default: Delivery dengan biaya default
