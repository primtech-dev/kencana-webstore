        ...
        <!-- <div class="relative">
            <a href="{{url('detail-produk')}}">
                <div id="product-grid" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                    ...
                    <div
                        class="bg-light-grey border border-light-grey rounded-lg shadow-sm hover:shadow-lg transition duration-200 cursor-pointer">
                        <div class="relative">
                        ...
                        <div class="p-3 md:p-4">
                            ...
                            <div class="flex items-center text-xs text-dark-grey mt-2">
                                <span class="text-primary">★</span><span class="ml-1">4.0</span><span
                                    class="ml-2 text-dark-grey">| 3 (ulasan)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="p-3 md:p-4">
                            <p class="text-xs text-dark-grey mb-1 line-clamp-1">Roofing & Walling</p>
                            <p
                                class="text-xs md:text-sm font-semibold text-dark-grey line-clamp-2 min-h-[1.5rem]">
                            ...
                            <div class="flex items-center text-xs text-dark-grey mt-2">
                                <span class="text-primary">★</span><span class="ml-1">4.9</span><span
                                    class="ml-2 text-dark-grey">| 200 (ulasan)</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-3 md:p-4">
                            ...
                            <div class="flex items-center text-xs text-dark-grey mt-2">
                                <span class="text-primary">★</span><span class="ml-1">4.2</span><span
                                    class="ml-2 text-dark-grey">| 58 (ulasan)</span>
                            </div>
                        </div>
                    </div>

                    <div
                        class="hidden lg:block bg-light-grey border border-light-grey rounded-lg shadow-sm hover:shadow-lg transition duration-200 cursor-pointer">
                        <div class="relative">
                        ...
                        <div class="p-3 md:p-4">
                            <p class="text-xs text-dark-grey mb-1 line-clamp-1">Kerangka Green House</p>
                            <p
                                class="text-xs md:text-sm font-semibold text-dark-grey line-clamp-2 min-h-[1.5rem]">
                                Spring Clip Green</p>
                            ...
                            <div class="flex items-center text-xs text-dark-grey mt-2">
                                <span class="text-primary">★</span><span class="ml-1">3.5</span><span
                                    class="ml-2 text-dark-grey">| 1 (ulasan)</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="relative">
            <a href="{{url('detail-produk')}}">
                <div id="product-grid" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                    ...
                    <div
                        class="bg-gray-100 border border-light-grey rounded-lg shadow-sm hover:shadow-lg transition duration-200 cursor-pointer">
                        <div class="relative">
                            <img src="{{asset('/asset/produk/ceiling 3d pu 4@1.5x.png')}}"
                                alt="Panel Ceiling A"
                                onerror="this.onerror=null;this.src='https://placehold.co/600x400/000/ffffff?text=Product+Image';"
                                class="h-32 sm:h-40 md:h-48 w-full object-cover rounded-t-lg">
                            <div
                    ...
                    <div
                        class="bg-gray-100 border border-light-grey rounded-lg shadow-sm hover:shadow-lg transition duration-200 cursor-pointer">
                        <div class="relative">
                            <img src="{{asset('/asset/produk/Louvre.png')}}"
                                alt="Louvre Vent 100"
                                onerror="this.onerror=null;this.src='https://placehold.co/600x400/000/ffffff?text=Product+Image';"
                                class="h-32 sm:h-40 md:h-48 w-full object-cover rounded-t-lg">
                            <div
                    ...
                    <div
                        class="bg-gray-100 border border-light-grey rounded-lg shadow-sm hover:shadow-lg transition duration-200 cursor-pointer">
                        <div class="relative">
                            <img src="{{asset('/asset/produk/1. Kanal C75-1.png')}}"
                                alt="Atap Insulasi 5mm"
                                onerror="this.onerror=null;this.src='https://placehold.co/600x400/000/ffffff?text=Product+Image';"
                                class="h-32 sm:h-40 md:h-48 w-full object-cover rounded-t-lg">
                            <div
                        ...
                        <div class="p-3 md:p-4">
                            ...
                            <p
                                class="text-xs md:text-sm font-semibold text-dark-grey line-clamp-2 min-h-[1.5rem]">
                                 Kanal C75 baja ringan</p>
                            <!-- <p class="text-xs text-light-grey line-through mt-2">Rp200.000</p> -->
                            <p class="text-base md:text-lg font-bold text-discount">Rp75.000</p>
                            <div class="flex items-center text-xs text-dark-grey mt-2">
                                <span class="text-primary">★</span><span class="ml-1">4.2</span><span
                                    class="ml-2 text-dark-grey">| 58 (ulasan)</span>
                            </div>
                    ...
                    <div
                        class="hidden lg:block bg-gray-100 border border-light-grey rounded-lg shadow-sm hover:shadow-lg transition duration-200 cursor-pointer">
                        <div class="relative">
                            <img src="{{asset('/asset/produk/reng-asimetris-1.jpg')}}"
                                alt="Spring Clip Green"
                                onerror="this.onerror=null;this.src='https://placehold.co/600x400/000/ffffff?text=Product+Image';"
                                class="h-32 sm:h-40 md:h-48 w-full object-cover rounded-t-lg">
                            <div
