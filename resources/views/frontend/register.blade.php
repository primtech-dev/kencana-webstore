...
<head>
    ...
    <title>Daftar Akun Baru Webstore Kencana</title>
        ...
        <div class="flex flex-col sm:flex-row bg-white rounded-xl shadow-2xl overflow-hidden w-full max-w-4xl">
            ...
            <div class="hidden sm:flex flex-col justify-center items-center p-8 bg-primary text-white w-1/2">
                <div class="text-center space-y-4">
                    ...
                    <h3 class="text-3xl font-extrabold">Mulai Belanja Hari Ini!</h3>
                    <p class="">Daftar sekarang dan nikmati penawaran eksklusif.</p>
                </div>
            </div>

            <div class="w-full sm:w-1/2 p-8 lg:p-12 space-y-6">
                <h2 class="text-2xl font-bold text-gray-900 text-center sm:text-left">Buat Akun Baru</h2>
