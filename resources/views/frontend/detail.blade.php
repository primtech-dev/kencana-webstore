...
<section class="container px-1 lg:px-[7%] mx-auto ">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10 bg-white shadow-sm mt-8 mb-8">
            ...
            <div class="lg:col-span-7 space-y-4">
                ...
                <div class="flex space-x-4">
                    <div class="hidden sm:flex flex-col space-y-3">
                        <div class="thumbnail w-16 h-16 bg-light-bg border-2 border-primary rounded-lg cursor-pointer flex items-center justify-center" 
                            data-image="https://cdn.ruparupa.io/fit-in/400x400/filters:format(webp)/filters:quality(90)/ruparupa-com/image/upload/Products/10578759_1.jpg"
                        ...
                        <div class="thumbnail w-16 h-16 bg-light-bg border border-light-grey rounded-lg cursor-pointer flex items-center justify-center" 
                            data-image="https://cdn.ruparupa.io/fit-in/400x400/filters:format(webp)/filters:quality(90)/ruparupa-com/image/upload/Products/10578759_3.jpg"
                            tabindex="0" role="button" aria-label="Gambar Produk 2: Detail Sandaran">
                            <span class="text-xs text-light-grey">Gbr 2</span>
                        </div>
                        <div class="thumbnail w-16 h-16 bg-light-bg border border-light-grey rounded-lg cursor-pointer flex items-center justify-center" 
                            data-image="https://cdn.ruparupa.io/fit-in/400x400/filters:format(webp)/filters:quality(90)/ruparupa-com/image/upload/Products/10578759_2.jpg"
                    ...
                    <div class="flex-grow">
                        <div class="w-full aspect-square bg-light-bg rounded-lg shadow-md flex items-center justify-center overflow-hidden">
                            <img id="main-product-image" 
                                 src="https://cdn.ruparupa.io/fit-in/400x400/filters:format(webp)/filters:quality(90)/ruparupa-com/image/upload/Products/10578759_1.jpg" 
                ...
                <div class="p-0 sm:p-4">
                    ...
                    <h1 class="text-2xl font-extrabold text-dark-grey mb-1">
                        Informa Carson Sofa Bed Moduler Sudut Fabric Kiri - Abu-abu
                    </h1>
                    <p class="text-sm text-dark-grey/80 mb-3">
                        <span class="font-bold">1</span> Ulasan | Brand: <span class="font-bold text-primary">INFORMA</span>
                    </p>

                    <p class="text-3xl font-extrabold text-primary mb-2" id="current-price">Rp11.999.000</p>
                    ...
                    <div class="mt-6">
                        ...
                        <div id="content-spesifikasi" class="tab-content pt-4 p-4 bg-light-bg rounded-b-lg text-sm space-y-2" role="tabpanel" aria-labelledby="tab-spesifikasi">
                            <div class="flex items-center space-x-2 text-primary font-semibold">
                                ...
                                <span>Memudahkan reka ulang | Jaminan originalitas</span>
                            </div>
                            <div class="pl-4 space-y-1">
                                <p><i class="fas fa-circle text-xs text-light-grey mr-2" aria-hidden="true"></i> Material cover dudukan & sandaran: **fabric**</p>
                                <p><i class="fas fa-circle text-xs text-light-grey mr-2" aria-hidden="true"></i> Tinggi dudukan: **45 cm**</p>
                                <p><i class="fas fa-circle text-xs text-light-grey mr-2" aria-hidden="true"></i> Tinggi kaki: **5 cm**</p>
                                <p><i class="fas fa-circle text-xs text-light-grey mr-2" aria-hidden="true"></i> Posisi tidur terbuka: **91 cm**</p>
                                <p><i class="fas fa-circle text-xs text-light-grey mr-2" aria-hidden="true"></i> Kualitas material yang tahan lama</p>
                                <p><i class="fas fa-circle text-xs text-light-grey mr-2" aria-hidden="true"></i> Desain sofa bed modern</p>
                            </div>
                        ...
                        <div id="content-informasi" class="tab-content pt-4 p-4 bg-light-bg rounded-b-lg text-sm space-y-2 hidden" role="tabpanel" aria-labelledby="tab-informasi">
                            ...
                            <p>Produk ini merupakan produk eksklusif INFORMA. Nikmati kemudahan mengubah sofa menjadi tempat tidur dengan mekanisme yang praktis. Cocok untuk ruang minimalis.</p>
                            <ul class="list-disc list-inside pl-4 text-dark-grey/80">
                                <li>Mudah dirawat</li>
                                <li>Tersedia dalam beberapa pilihan warna</li>
                                <li>Kapasitas beban maksimal 200 kg</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-5 mt-6 lg:mt-0 lg:order-last lg:sticky lg:top-10 self-start">
                <div class="p-6 bg-white rounded-xl shadow-md border border-light-grey/50"> {{-- Rounded-xl untuk konsistensi --}}
                    ...
                    <div class="flex justify-end items-center text-xs text-dark-grey/80 mb-4 space-x-2">
                        ...
                        <span class="text-primary font-extrabold text-lg ml-2" id="subtotal-price" role="status" aria-live="polite">Rp11.999.000</span>
                    </div>
        ...
        <div class="mt-12">
            ...
            <div class="flex overflow-x-scroll space-x-4 pb-4"> {{-- Mengganti scrollbar-hide dengan overflow-x-scroll --}}
                @php
                $products = [
                ['name' => 'Informa Neo Faith Sofa Bed Fabric Patchwork ...', 'price' => '2.698.000', 'old_price' => '3.500.000', 'rating' => 4.5],
                ['name' => 'Informa Paradis Sofa Bed Fabric - Abu-abu', 'price' => '3.998.000', 'old_price' => '4.998.000', 'rating' => 4.8],
                ['name' => 'Informa Marvel Sofa Bed Fabric - Abu-abu', 'price' => '5.998.000', 'old_price' => '7.998.000', 'rating' => 4.2],
                ['name' => 'Informa Vienna Sofa Bed Fabric Corduroy - Abu-abu', 'price' => '4.198.000', 'old_price' => '6.198.000', 'rating' => 5.0],
                ['name' => 'Informa Bloom Sofa Bed Fabric - Biru Muda', 'price' => '5.198.000', 'old_price' => '6.998.000', 'rating' => 4.7],
                ['name' => 'Informa Daphrine Sectional Sofa Bed Fabric - Abu-abu...', 'price' => '999.000', 'old_price' => '1.999.000', 'rating' => 4.6],
                ];
                @endphp
                ...
                <div class="flex-shrink-0 w-40 sm:w-48 bg-white p-3 rounded-lg shadow-sm border border-light-grey/50 hover:shadow-md transition duration-200">
                    <div class="w-full aspect-square bg-light-bg mb-2 rounded-md overflow-hidden">
                        <img src="https://via.placeholder.com/400x400/9CA3AF/374151?text={{ $product['name'] }}" alt="{{ $product['name'] }}" class="object-cover w-full h-full">
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Ambil harga dari teks elemen dan konversi ke integer (Rp11.999.000 -> 11999000)
