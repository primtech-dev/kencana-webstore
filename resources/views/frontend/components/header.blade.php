...
<header class="shadow-md sticky top-0 z-50">
    ...
    <div class="bg-light-bg text-dark-grey text-sm hidden md:block border-b border-light-grey">
    ...
    <div class="bg-white border-b border-gray-100">
        <div class="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2 md:space-x-6 flex-shrink-0">
                <button id="open-menu-btn" class="md:hidden text-gray-700 p-1 hover:text-primary">☰</button>
                ...
                <a href="#" class="flex flex-col items-center leading-none flex-shrink-0 mr-4">
                    <div class="flex items-center bg-transparent p-1 rounded-md">
                        <span class="text-2xl font-extrabold text-primary ml-1">KENCANA</span>
                    </div>
                    <span class="text-xs text-gray-700 mt-0.5 hidden sm:block">inspirasi rumah impian</span>
                </a>
            ...
            <div class="flex-grow mx-2 md:mx-6 w-full max-w-lg lg:max-w-2xl">
                <div class="flex border border-gray-300 rounded-lg overflow-hidden h-10">
                    ...
                    <button
                        class="bg-primary hover:bg-[#D4591F] text-white w-10 md:w-16 flex items-center justify-center transition duration-200 flex-shrink-0">
            ...
            <div class="flex items-center space-x-3 md:space-x-4 flex-shrink-0 ml-4">
                ...
                <button class="text-gray-500 hover:text-primary relative p-1 md:p-2 hidden sm:block">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="absolute top-0 right-0 inline-flex items-center justify-center h-4 w-4 text-[10px] font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">3</span>
                </button>
                ...
                <a href="{{ url('keranjang') }}" class="text-gray-500 hover:text-primary relative p-1 md:p-2">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                     <span class="absolute top-0 right-0 inline-flex items-center justify-center h-4 w-4 text-[10px] font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">1</span>
                </a>
                ...
                <div class="flex items-center space-x-1 text-gray-700 font-semibold hover:text-primary cursor-pointer hidden md:flex">
    ...
    <div id="bottom-bar" class="bg-white border-t border-b border-light-grey shadow-sm hidden md:block">
        <div class="container mx-auto flex items-center relative">
            ...
            <button id="category-scroll-left"
                class="absolute left-0 top-0 bottom-0 px-2 bg-white h-full flex items-center border-r border-light-grey shadow-lg cursor-pointer z-10 hover:bg-light-bg transition duration-150">
            ...
            <button id="category-scroll-right"
                class="absolute right-0 top-0 bottom-0 px-2 bg-white h-full flex items-center border-l border-light-grey shadow-lg cursor-pointer z-10 hover:bg-light-bg transition duration-150">
                <svg class="w-4 h-4 text-dark-grey" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
